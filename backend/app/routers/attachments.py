...
from .common import clean_file_name, ensure_in_trip, ensure_trip_member, get_trip_scoped
...
def rename_attachment(
    ...
    attachment = get_trip_scoped(db, user, Attachment, attachment_id)
    attachment.original_name = clean_file_name(
        payload.original_name, attachment.original_name
    )
    db.commit()
    db.refresh(attachment)
    return attachment
